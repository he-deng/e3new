...
/* Private defines -------------------------------------------------------------*/
#define CF1106_SYNC0_PIN    GPIO_PINS_0
#define CF1106_SYNC0_GPIO_PORT    GPIOB
#define CF1106_SYNC1_PIN    GPIO_PINS_1
#define CF1106_SYNC1_GPIO_PORT    GPIOB
#define SPI2_CS_PIN    GPIO_PINS_12
#define SPI2_CS_GPIO_PORT    GPIOB
#define CF1106_IRQ_PIN    GPIO_PINS_5
#define CF1106_IRQ_GPIO_PORT    GPIOB

#define DESELECT_SPI      gpio_bits_set(SPI2_CS_GPIO_PORT,SPI2_CS_PIN)
#define SELECT_SPI        gpio_bits_reset(SPI2_CS_GPIO_PORT,SPI2_CS_PIN) 
